...
(function ($, document, window) {
    ...
    defaults = {
        ...
        next: "next",
        close: "close",
        xhrError: "Falha ao carregar a página. Feche a janela e tente novamente.",
        imgError: "Falha no carregamento.",
    ...
    publicMethod.load = function (launched) {
        ...
        if (settings.inline) {
            ...
            //prep(status === 'error' ? $(this).contents() : $(this).contents());
            });
        }
    };
    ...
    // Note: to use this within an iframe use the following format: parent.$.fn.colorbox.close();
    publicMethod.forceclose = function () {
        open = true;
        closing = false;
